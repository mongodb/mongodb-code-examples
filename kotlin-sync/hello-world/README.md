# Get Started with the MongoDB Kotlin Sync Driver
...
Install the MongoDB Kotlin Sync driver. Follow the
[Kotlin Sync installation guide](https://www.mongodb.com/docs/drivers/kotlin/sync/current/get-started/)
for your platform.

Navigate into the `kotlin-sync/hello-world` project directory and
compile the application:

```bash
cd mongodb-code-examples/kotlin-sync/hello-world
mvn compile
```
