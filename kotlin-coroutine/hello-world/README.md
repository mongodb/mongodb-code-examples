# Get Started with the MongoDB Kotlin Coroutine Driver
...
The app uses the MongoDB Kotlin Coroutine driver, which exposes the
driver operations as
[coroutine](https://kotlinlang.org/docs/coroutines-overview.html)
suspending functions and returns query results as a Kotlin `Flow`.
...
Install the MongoDB Kotlin Coroutine driver. Follow the
[Kotlin Coroutine installation guide](https://www.mongodb.com/docs/languages/kotlin/kotlin-driver/current/get-started/)
for your platform.

Navigate into the `kotlin-coroutine/hello-world` project directory and
compile the application:

```bash
cd mongodb-code-examples/kotlin-coroutine/hello-world
mvn compile
```
